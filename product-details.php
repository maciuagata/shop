                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="product-details"><!--product-details-->
                            ...
                            <div class="col-sm-7">
                                <div class="product-information"><!--/product-information-->
                                    ...
                                    <p><b>Kiekis:</b> Sandėlyje</p>
                                    <p><b>Būsena:</b> Nauja</p>
                                    <p><b>Gamintojas:</b> D&G</p>
                        ...
                        <div class="category-tab shop-details-tab"><!--category-tab-->                     
                            <div class="tab-content">
                                ...
                                <p> Prekės aprašas </p>
                                <p>Prieš užsakant tokias paslaugas kaip elektroninių parduotuvių kūrimas vienas iš darbų , kuriuos reikia padaryti NAUJAI el-parduotuvei tai - TINKAMAS PREKIŲ KATEGORIJŲ SUKŪRIMAS. Tinkamas- tai reiškia, kad sudaryta prekių kategorijų struktūra leistų klientams lengvai orientuotis el-parduotuvėje. Dažnai netinkamas el-parduotuvės struktūros padaro didelį atmetimo rodiklį (angl. Bounce rate). Bounce rate galite stebėti.</p>
                                <p>Prieš užsakant tokias paslaugas kaip elektroninių parduotuvių kūrimas vienas iš darbų , kuriuos reikia padaryti NAUJAI el-parduotuvei tai - TINKAMAS PREKIŲ KATEGORIJŲ SUKŪRIMAS. Tinkamas- tai reiškia, kad sudaryta prekių kategorijų struktūra leistų klientams lengvai orientuotis el-parduotuvėje. Dažnai netinkamas el-parduotuvės struktūros padaro didelį atmetimo rodiklį (angl. Bounce rate). Bounce rate galite stebėti.</p>
